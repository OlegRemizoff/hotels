...
class BookingDAO(BaseDAO):
    ...
    async def add(
        ...
        SELECT rooms.quantity - COUNT(booked_rooms.rom_id) FROM rooms
        ...
        async with async_session_maker() as session:
            ...
            get_rooms_left = select(
                (Rooms.quantity - func.count(booked_rooms.c.room_id)).label("rooms_left")
                    ...
                    booked_rooms, booked_rooms.c.room_id == Rooms.id, isouter=True # c = cte
            ...
            if rooms_left > 0:
                ...
                price: int = price.scalar() # цена отеля за один день проживания
